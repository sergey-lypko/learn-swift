...
// *  *  *  Initializer Delegation (value type)  *  *  * 
// *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *
...
// обозначенные инициализаторы являются главными при инициализации классов и обычно таких 
...
// каждый класс должен иметь как минимум один обозначенный инициализатор
// в некоторых случаях это требования удовлетворяется путем наследования 
// одного или более обозначенных инициализаторов от родительского класса

// удобные инициализаторы являются второстепенными и предоставляют возможность вызвать обозначенные 
// инициализаторы текущего класса с какими-либо предопределенными параметрами
// удобный инициализатор может так же служить для конкретного применения класса 
// или определенного входящего параметра/параметров

// удобные инициализаторы не являются обязательными и используются для сокращения, а так же 
